...
- Current mission: `.ai-governance/CURRENT_MISSION.md`
- Current relay snapshot: `.ai-governance/RELAY_STATE.md`
- Relay event ledger: `.ai-governance/RELAY_EVENTS.jsonl`
- Architecture decisions: `.ai-governance/DECISIONS.md` and `.ai-governance/ARCHITECTURE-NO-GO.md`
- Evidence and reviews: project-specific evidence directories and Git history
