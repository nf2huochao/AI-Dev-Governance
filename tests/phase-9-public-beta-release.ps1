...
Assert-Contains $readme 'v0.1.2' 'README must identify the current public beta release.'
...
Assert-Contains $readme '--branch v0.1.2' 'README install command must fetch the current release.'
