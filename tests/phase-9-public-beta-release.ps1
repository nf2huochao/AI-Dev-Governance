...
Assert-Contains $readme 'V0.1 Public Beta' 'README must identify the release as Public Beta.'
...
Assert-Contains $readme 'v0.1.0-beta.1' 'README install command must pin the public beta tag.'
